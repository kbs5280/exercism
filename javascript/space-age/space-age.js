...
class SpaceAge {
  ...
  onEarth() {
    return this.truncateFloat(3.16877086433912e-8 * this.seconds);
  }
  ...
  onMars() {
    return this.truncateFloat(1.6846424533248636e-8  * this.seconds);
  }
  ...
  truncateFloat(result) {
    return Math.round((result) * 100) / 100;
  };
}


// ES5 comments left for referrence
